...
const ExperienceDetails = ({
  ...
  return (
    ...
    <Card className="mx-auto flex w-full max-w-4xl flex-col justify-between gap-4 p-8 md:flex-row md:gap-8 shadow-lg transition-transform duration-500 md:hover:scale-105">
